...
project = u'glypy'
copyright = u'2019, J. Klein, Dr. J. Zaia'
...
version = '0.0.0'
if os.path.exists("../glypy/version.py"):
...
texinfo_documents = [
  ('index', 'glypy', u'glypy Documentation',
   u'J. Klein, Dr. J. Zaia', 'glypy', 'One line description of project.',
   'Miscellaneous'),
]
